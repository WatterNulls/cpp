...
void main(){
	...
	//Leitura
		for(I=0;I<MAX;I++){
			do{
				printf("Entre com a Matrícula do %iº Funcionário: ",(I+1));
			...
			do{
				printf("Entre com a Profissão de %s",FXPTO[I].NOME);
	...
	//Processamento
			printf("\n-- LISTAGEM --\n\n\t1 - Funcionários por Departamento\n\t2 - Funcionários com 10 Anos de Admição");
			scanf("%i", &OPCAO);
			
			switch(OPCAO){
				case 1:		printf("MATRICULA		NOME		DATA ADMIÇÃO		DEPARTAMENTO		ESTADO");
				...
				case 2: for(I=0;I<MAX;I++){
							printf("MATRICULA		NOME		DATA ADMIÇÃO		DEPARTAMENTO		ESTADO");
